...
#include "NSNormalMonsterStatusWidget.generated.h"
 ...
 * 파일 생성일: 26.07.13
 *
 * 클래스 개요: 일반 몬스터 위에 표시되는 상태 UI 위젯입니다.
 * ViewModel이 전달한 Percent와 표시 정책만 화면에 반영합니다.
 */
UCLASS()
class NEOSANCTUM_API UNSNormalMonsterStatusWidget : public UCommonUserWidget
{
	GENERATED_BODY()
...
private:
	// 몬스터 이름을 표시하는 CommonText 변수
	UPROPERTY(meta = (BindWidgetOptional))
	TObjectPtr<UCommonTextBlock> CommonText_MonsterName;
