...
namespace NSGameplayTags
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Part_Visual_ThighArmor);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Part_Visual_ShinArmor);
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Part_Visual_ForearmArmor);
